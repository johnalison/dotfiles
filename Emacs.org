...
#+RESULTS:
| git-commit-ensure-comment-gap | git-commit-save-message | git-commit-setup-changelog-support | git-commit-turn-on-auto-fill | git-commit-propertize-diff | bug-reference-mode | my/insert-commit-message |
